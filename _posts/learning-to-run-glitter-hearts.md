...
<!-- 
As a DM I struggled a fair bit with this. For example: if the characters are running out of a collapsing cave, and there are falling rocks to avoid, I want to say "roll to *Thwart Peril*" (that's the Glitter Hearts move for avoiding danger) before revealing the danger. Then, if they succeed, I tell them how they narrowly dodge the rock. But what I should say is "a big rocks falls right into your path, what do you do?" Then, if the player says "I want to dodge", I can tell them to thwart peril there.

I suppose that's a good lesson to learn for any game! Having the players narrate what their characters do and applying mechanics after puts a lot of power in the players and also lessens my work. -->
